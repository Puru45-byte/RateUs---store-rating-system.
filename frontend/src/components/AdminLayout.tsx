  ...
  const renderNavLinks = () => {
    return (
      <nav className="space-y-1 text-left">
        <Link to="/admin" className={navItemClass(isActive('/admin') && !isActive('/admin/users') && !isActive('/admin/stores') && !isActive('/admin/settings'))}>
        ...
        <Link to="/admin/stores" className={navItemClass(isActive('/admin/stores'))}>
          <StoreIcon className="w-4.5 h-4.5" /> Stores
        </Link>

        <Link to="/admin/settings" className={navItemClass(isActive('/admin/settings'))}>
        ...
        <div className="h-full flex flex-col justify-between p-5 overflow-y-auto">
          ...
          <div className="bg-surface-soft border border-border/60 p-4 rounded-card text-left flex items-center gap-3 mt-6">
            ...
            <div className="overflow-hidden">
              ...
              <span className="text-[9px] font-bold text-muted uppercase tracking-wider">System Admin</span>
            </div>
          </div>
        </div>
      </aside>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:flex flex-col">
                  ...
                  <span className="text-[10px] font-bold text-muted uppercase tracking-wider">Admin</span>
                </div>
